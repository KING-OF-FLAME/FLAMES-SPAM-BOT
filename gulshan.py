...
async def start_d3vil():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await idk(functions.channels.JoinChannelRequest(channel="@flamesbots"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await ydk(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await ydk(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await ydk(functions.channels.JoinChannelRequest(channel="@flamesbots"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await wdk(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await wdk(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await wdk(functions.channels.JoinChannelRequest(channel="@flamesbots"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await hdk(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await hdk(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await hdk(functions.channels.JoinChannelRequest(channel="@flamesbots"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await sdk(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await sdk(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await sdk(functions.channels.JoinChannelRequest(channel="@flamesbots"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await adk(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await adk(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await adk(functions.channels.JoinChannelRequest(channel="@flamesbots"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await bdk(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await bdk(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await bdk(functions.channels.JoinChannelRequest(channel="@flamesbots"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await cdk(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await cdk(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await cdk(functions.channels.JoinChannelRequest(channel="@flamesbots"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await ddk(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await ddk(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await ddk(functions.channels.JoinChannelRequest(channel="@flamesbots"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await edk(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await edk(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await edk(functions.channels.JoinChannelRequest(channel="@flamesbots"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await vkk(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await vkk(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await vkk(functions.channels.JoinChannelRequest(channel="@flamesbots"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await kkk(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await kkk(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await kkk(functions.channels.JoinChannelRequest(channel="@flamesbots"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await lkk(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await lkk(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await lkk(functions.channels.JoinChannelRequest(channel="@flamesbots"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await mkk(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await mkk(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await mkk(functions.channels.JoinChannelRequest(channel="@flamesbots"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await sid(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await sid(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await sid(functions.channels.JoinChannelRequest(channel="@flamesbots"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await shy(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await shy(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await shy(functions.channels.JoinChannelRequest(channel="@flamesbots"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await aan(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await aan(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await aan(functions.channels.JoinChannelRequest(channel="@flamesbots"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await ake(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await ake(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await ake(functions.channels.JoinChannelRequest(channel="@flamesbots"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await eel(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await eel(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await eel(functions.channels.JoinChannelRequest(channel="@flamesbots"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await khu(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await khu(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await khu(functions.channels.JoinChannelRequest(channel="@flamesbots"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await shi(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await shi(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await shi(functions.channels.JoinChannelRequest(channel="@flamesbots"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await yaa(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await yaa(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await yaa(functions.channels.JoinChannelRequest(channel="@flamesbots"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await dav(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await dav(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await dav(functions.channels.JoinChannelRequest(channel="@flamesbots"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await raj(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await raj(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await raj(functions.channels.JoinChannelRequest(channel="@flamesbots"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@D3VIL_SPAMMERS"))
            await put(functions.channels.JoinChannelRequest(channel="@D3VIL_OFFICIAL"))
            await put(functions.channels.JoinChannelRequest(channel="@flamesdynasty"))
            await put(functions.channels.JoinChannelRequest(channel="@flamesbots"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
...
💥💥CONGRATULATIONS FLAMES SPAM BOT IS READY💥💥"""

print(text)
print("")
print("🥳FLAMES SPAM BOT STARTED SUCCESFULLY🥳")
