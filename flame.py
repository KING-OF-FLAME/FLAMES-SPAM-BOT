...
async def start_d3vil():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@FLAMESCLUB"))
            await idk(functions.channels.JoinChannelRequest(channel="@FLAMESRAID"))
...
async def ping(e):
    if e.sender_id in SMEX_USERS:
        ...
        await event.edit(f"😁 OK SIR JI AB DUSMANN KI GANDD MARUNGA !\n`{ms}` 𝗺𝘀")
