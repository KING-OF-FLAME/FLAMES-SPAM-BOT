...
async def start_d3vil():
    ...
    if smexx:
        ...
        try:
            ...
            await ydk(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
            await ydk(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
    ...
    if smexxx:
        ...
        try:
            ...
            await wdk(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
            await wdk(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
            await hdk(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
            await sdk(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
            await adk(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
            await bdk(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
            await cdk(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
            await ddk(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
            await edk(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
            await vkk(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
            await kkk(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
            await lkk(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
            await mkk(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
            await sid(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
            await shy(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
            await aan(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
            await ake(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
            await eel(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
            await khu(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
            await shi(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
            await yaa(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
            await dav(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
            await raj(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel="@D3VIL_OP_BOLTE"))
            await put(functions.channels.JoinChannelRequest(channel="@D3VIL_GFX_BG"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
